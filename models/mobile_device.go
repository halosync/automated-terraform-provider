...
type MobileDevice struct {
	...
	// applications
	Applications []*MobileDeviceApplicationsItems0 `json:"applications"`

	// certificates
	Certificates []*MobileDeviceCertificatesItems0 `json:"certificates"`

	// configuration profiles
	ConfigurationProfiles []*MobileDeviceConfigurationProfilesItems0 `json:"configuration_profiles"`

	// extension attributes
	ExtensionAttributes []*MobileDeviceExtensionAttributesItems0 `json:"extension_attributes"`
...
type MobileDeviceApplicationsItems0 struct {
	...
	// application
	Application *MobileDeviceApplicationsItems0Application `json:"application,omitempty"`
...
func (m *MobileDeviceApplicationsItems0) validateApplication(formats strfmt.Registry) error {
...
func (m *MobileDeviceApplicationsItems0) validateSize(formats strfmt.Registry) error {
...
func (m *MobileDeviceApplicationsItems0) contextValidateApplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MobileDeviceApplicationsItems0) contextValidateSize(ctx context.Context, formats strfmt.Registry) error {
...
// MobileDeviceApplicationsItems0Application mobile device applications items0 application
//
// swagger:model MobileDeviceApplicationsItems0Application
type MobileDeviceApplicationsItems0Application struct {
...
func (m *MobileDeviceApplicationsItems0Application) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this mobile device applications items0 application based on context it is used
func (m *MobileDeviceApplicationsItems0Application) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *MobileDeviceApplicationsItems0Application) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *MobileDeviceApplicationsItems0Application) UnmarshalBinary(b []byte) error {
	var res MobileDeviceApplicationsItems0Application
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
func (m *MobileDeviceConfigurationProfilesItems0) validateSize(formats strfmt.Registry) error {
	if swag.IsZero(m.Size) { // not required
		return nil
	}
...
func (m *MobileDeviceConfigurationProfilesItems0) contextValidateSize(ctx context.Context, formats strfmt.Registry) error {
