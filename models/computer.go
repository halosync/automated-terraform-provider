...
type Computer struct {
	...
	ExtensionAttributes []*ComputerExtensionAttributesItems0 `json:"extension_attributes"`
...
type ComputerExtensionAttributesItems0 struct {
	...
	// extension attribute
	ExtensionAttribute *ComputerExtensionAttributesItems0ExtensionAttribute `json:"extension_attribute,omitempty"`
}
...
func (m *ComputerExtensionAttributesItems0) validateExtensionAttribute(formats strfmt.Registry) error {
...
func (m *ComputerExtensionAttributesItems0) contextValidateExtensionAttribute(ctx context.Context, formats strfmt.Registry) error {
...
// ComputerExtensionAttributesItems0ExtensionAttribute computer extension attributes items0 extension attribute
//
// swagger:model ComputerExtensionAttributesItems0ExtensionAttribute
type ComputerExtensionAttributesItems0ExtensionAttribute struct {
...
func (m *ComputerExtensionAttributesItems0ExtensionAttribute) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this computer extension attributes items0 extension attribute based on context it is used
func (m *ComputerExtensionAttributesItems0ExtensionAttribute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ComputerExtensionAttributesItems0ExtensionAttribute) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ComputerExtensionAttributesItems0ExtensionAttribute) UnmarshalBinary(b []byte) error {
	var res ComputerExtensionAttributesItems0ExtensionAttribute
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
