...
// ContextValidate validate this categories based on the context it is used
...
func (m *CategoriesItems0) validateCategory(formats strfmt.Registry) error {
...
func (m *CategoriesItems0) validateSize(formats strfmt.Registry) error {
...
// ContextValidate validate this categories items0 based on the context it is used
func (m *CategoriesItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CategoriesItems0) contextValidateCategory(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CategoriesItems0) contextValidateSize(ctx context.Context, formats strfmt.Registry) error {
